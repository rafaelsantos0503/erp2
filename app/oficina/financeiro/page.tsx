                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {conta.recorrencia !== "NENHUMA" && (
                              <span className="flex items-center gap-1 px-2 py-0.5 rounded-full text-xs bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400">
                                <Repeat className="h-3 w-3" />
                                {conta.recorrencia}
                              </span>
                            )}
                            <button
                              onClick={() => togglePago(conta.id)}
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {conta.ordemServicoId && (
                              <span className="px-2 py-0.5 rounded-full text-xs bg-purple-100 text-purple-800 dark:bg-purple-900/20 dark:text-purple-400">
                            ...
                            <button
                              onClick={() => toggleRecebido(conta.id)}
                              className={`px-2 py-1 rounded text-xs font-medium transition-colors ${
                                conta.recebido
                                  ? "bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400"
